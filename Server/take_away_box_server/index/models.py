...
class Dest(models.Model):
    str_dest = models.CharField(max_length=45, blank=True, null=True)
...
class IndexStaffInfo(models.Model):
    staff_id = models.CharField(primary_key=True, max_length=5)
    stuff_name = models.CharField(max_length=5)
    staff_pwd = models.CharField(max_length=10)

    class Meta:
        managed = False
        db_table = 'index_staff_info'
